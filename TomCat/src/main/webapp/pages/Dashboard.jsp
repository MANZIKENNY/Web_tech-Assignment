...
<%
  // Determine if current user has HR role based on roleDisplay attribute
  String roleDisplay = (String) request.getAttribute("roleDisplay");
  boolean isHR = "HR".equals(roleDisplay);
%>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <style>
      ...
      /* Hide elements from non-HR users */
      .hr-only {
  ...
  <body>
          ...
          <nav>
            ...
            <div class="profile">
              <div class="profile-image-container upload-picture-open">
                <img
                  src="${sessionScope.user.profilePicture != null ? pageContext.request.contextPath.concat('/assets/profile/').concat(sessionScope.user.profilePicture) : 'assets/dp 1.png'}"
                  alt="profile"
                  class="profile-img"
              ...
              <div class="form-container">
                <div class="inner-modal">
                  ...
                  <div class="inner-modal">
                    ...
                    <select name="emp-gender" id="view-emp-gender" <%= isHR ? "" : "disabled" %>>
                  ...
                  <div class="inner-modal">
                    ...
                    <input type="date" name="emp-date" id="view-emp-date" <%= isHR ? "" : "readonly" %> />
                  </div>
                </div>
                <div>
                  <div class="inner-modal">
                    <label for="view-emp-position">Position</label>
                    <select name="emp-position" id="view-emp-position" <%= isHR ? "" : "disabled" %>>
                      <% 
                  ...
                  <div class="inner-modal">
                    ...
                    <select name="emp-qualification" id="view-emp-qualification" <%= isHR ? "" : "disabled" %>>
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
        ...
        if (!isHR) {
          // Hide HR controls even if they're in the HTML
          document.querySelectorAll('.add-open, .delete-open').forEach(el => {
