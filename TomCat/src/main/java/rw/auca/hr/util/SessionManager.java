...
public class SessionManager {
    ...
    public static void createAuthenticatedSession(HttpServletRequest request, int userId, 
        ...
        if (existingSession != null) {
            // Update ServerStats for session destruction
            System.out.println("Invalidating existing session: " + existingSession.getId());
            ServerStats.sessionDestroyed(existingSession.getId());
        ...
        // Update ServerStats for active sessions
        System.out.println("Creating new session: " + session.getId());
        ServerStats.sessionCreated(session.getId());
    }
    ...
    public static void logout(HttpServletRequest request) {
        ...
        if (session != null) {
            ...
            ServerStats.sessionDestroyed(session.getId());
            session.invalidate();
        }
    }
}
